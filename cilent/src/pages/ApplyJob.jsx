...
function ApplyJob() {
  ...
  const applyHandler = async () => {
    console.log('Apply handler called!') // Add this line
    try {
        if (!userData) {
            console.log('No user data') // Add this too
            return toast.error('Login to apply for jobs')
        }
        
        if (!userData.resume) {
            console.log('No resume') // Add this too
            navigate('/applications')
            return toast.error('Upload resume to apply')
        }

        console.log('About to make API call') // Add this
